...
from views import calculator, codegen_lab, hangman, home, password_gen_ui
...
PAGE_PASSWORD_GEN = "🔐 Password Generator"
...
with st.sidebar:
    ...
    page = st.radio(
        "Navigate",
        [PAGE_HOME, PAGE_CALCULATOR, PAGE_CODEGEN, PAGE_PASSWORD_GEN, PAGE_HANGMAN],
...
if page == PAGE_HOME:
    ...
    codegen_lab.render()
elif page == PAGE_PASSWORD_GEN:
    password_gen_ui.render()
